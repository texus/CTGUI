...
void tgui_setTextInputUsesTextCursorByDefault(tguiBool useIBeam)
{
    tgui::setTextInputUsesTextCursorByDefault(useIBeam);
}

tguiBool tgui_getTextInputUsesTextCursorByDefault(void)
{
    return tgui::getTextInputUsesTextCursorByDefault();
}
