...
public :
    ...
    sfShapeImpl(sfShapeGetPointCountCallback getPointCountCallback,
                sfShapeGetPointCallback      getPointCallback,
                void*                        userData) :
    myGetPointCountCallback(getPointCountCallback),
    myGetPointCallback     (getPointCallback),
    myUserData             (userData)
    {
    }
