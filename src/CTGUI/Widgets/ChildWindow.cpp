...
void tguiChildWindow_connect_onMousePress(tguiWidget* widget, void (*function)(), const char** error)
{
    try
    {
...
void tguiChildWindow_connect_onClose(tguiWidget* widget, void (*function)(), const char** error)
{
    try
    {
...
void tguiChildWindow_connect_onMinimize(tguiWidget* widget, void (*function)(), const char** error)
{
    try
    {
...
void tguiChildWindow_connect_onMaximize(tguiWidget* widget, void (*function)(), const char** error)
{
    try
    {
