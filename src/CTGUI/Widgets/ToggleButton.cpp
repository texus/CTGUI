...
void tguiToggleButton_setDown(tguiWidget* widget, tguiBool down)
{
    DOWNCAST(widget->This)->setDown(down != 0);
}

tguiBool tguiToggleButton_isDown(const tguiWidget* widget)
{
    return DOWNCAST(widget->This)->isDown();
}
