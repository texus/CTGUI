...
CTGUI_API tguiLayout* tguiLayout_create_fromString(const char* expression);
...
CTGUI_API tguiLayout2d* tguiLayout2d_create_fromLayouts(tguiLayout* x, tguiLayout* y);
CTGUI_API tguiLayout2d* tguiLayout2d_create_fromString(const char* expression);
