...
CTGUI_API void tguiMenuBar_setMinimumSubMenuWidth(tguiWidget* widget, unsigned int minimumWidth);
CTGUI_API unsigned int tguiMenuBar_getMinimumSubMenuWidth(const tguiWidget* widget);
