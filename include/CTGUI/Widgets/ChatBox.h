...
CTGUI_API void tguiChatBox_addLineWithColor(tguiWidget* thisWidget, tguiUtf32 text, tguiColor color);

CTGUI_API void tguiChatBox_addLineWithColorAndStyle(tguiWidget* thisWidget, tguiUtf32 text, tguiColor color, tguiUint32 style);

CTGUI_API tguiUtf32 tguiChatBox_getLine(const tguiWidget* thisWidget, size_t lineIndex);

CTGUI_API tguiColor tguiChatBox_getLineColor(const tguiWidget* thisWidget, size_t lineIndex);
...
CTGUI_API void tguiChatBox_setTextColor(tguiWidget* thisWidget, tguiColor value);
CTGUI_API tguiColor tguiChatBox_getTextColor(const tguiWidget* thisWidget);
