...
CTGUI_API void tguiBoxLayoutRatios_add(tguiWidget* layout, tguiWidget* widget, float ratio, tguiUtf32 widgetName);
CTGUI_API void tguiBoxLayoutRatios_insert(tguiWidget* layout, size_t index, tguiWidget* widget, float ratio, tguiUtf32 widgetName);
