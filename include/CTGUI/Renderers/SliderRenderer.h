...
CTGUI_API void tguiSliderRenderer_setTrackColor(tguiRenderer* thisRenderer, tguiColor value);
CTGUI_API tguiColor tguiSliderRenderer_getTrackColor(const tguiRenderer* thisRenderer);

CTGUI_API void tguiSliderRenderer_setTrackColorHover(tguiRenderer* thisRenderer, tguiColor value);
CTGUI_API tguiColor tguiSliderRenderer_getTrackColorHover(const tguiRenderer* thisRenderer);

CTGUI_API void tguiSliderRenderer_setThumbColor(tguiRenderer* thisRenderer, tguiColor value);
CTGUI_API tguiColor tguiSliderRenderer_getThumbColor(const tguiRenderer* thisRenderer);

CTGUI_API void tguiSliderRenderer_setThumbColorHover(tguiRenderer* thisRenderer, tguiColor value);
CTGUI_API tguiColor tguiSliderRenderer_getThumbColorHover(const tguiRenderer* thisRenderer);

CTGUI_API void tguiSliderRenderer_setBorderColor(tguiRenderer* thisRenderer, tguiColor value);
CTGUI_API tguiColor tguiSliderRenderer_getBorderColor(const tguiRenderer* thisRenderer);

CTGUI_API void tguiSliderRenderer_setBorderColorHover(tguiRenderer* thisRenderer, tguiColor value);
CTGUI_API tguiColor tguiSliderRenderer_getBorderColorHover(const tguiRenderer* thisRenderer);
