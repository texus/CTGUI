...
CTGUI_API void tguiListViewRenderer_setBorders(tguiRenderer* renderer, tguiOutline* outline);
CTGUI_API tguiOutline* tguiListViewRenderer_getBorders(const tguiRenderer* renderer);

CTGUI_API void tguiListViewRenderer_setPadding(tguiRenderer* renderer, tguiOutline* outline);
...
CTGUI_API void tguiListViewRenderer_setScrollbarWidth(tguiRenderer* renderer, float value);
