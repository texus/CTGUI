...
#ifndef CTGUI_BUTTONRENDERER_H
#define CTGUI_BUTTONRENDERER_H
...
CTGUI_API void tguiButtonRenderer_setTextureHover(tguiRenderer* thisRenderer, const tguiTexture* value);
CTGUI_API const tguiTexture* tguiButtonRenderer_getTextureHover(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextureFocused(tguiRenderer* thisRenderer, const tguiTexture* value);
CTGUI_API const tguiTexture* tguiButtonRenderer_getTextureFocused(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextureDisabled(tguiRenderer* thisRenderer, const tguiTexture* value);
CTGUI_API const tguiTexture* tguiButtonRenderer_getTextureDisabled(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextureDown(tguiRenderer* thisRenderer, const tguiTexture* value);
CTGUI_API const tguiTexture* tguiButtonRenderer_getTextureDown(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextureDownHover(tguiRenderer* thisRenderer, const tguiTexture* value);
CTGUI_API const tguiTexture* tguiButtonRenderer_getTextureDownHover(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextureDownFocused(tguiRenderer* thisRenderer, const tguiTexture* value);
CTGUI_API const tguiTexture* tguiButtonRenderer_getTextureDownFocused(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextureDownDisabled(tguiRenderer* thisRenderer, const tguiTexture* value);
CTGUI_API const tguiTexture* tguiButtonRenderer_getTextureDownDisabled(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextStyle(tguiRenderer* thisRenderer, tguiUint32 value);
CTGUI_API tguiUint32 tguiButtonRenderer_getTextStyle(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextStyleHover(tguiRenderer* thisRenderer, tguiUint32 value);
CTGUI_API tguiUint32 tguiButtonRenderer_getTextStyleHover(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextStyleFocused(tguiRenderer* thisRenderer, tguiUint32 value);
CTGUI_API tguiUint32 tguiButtonRenderer_getTextStyleFocused(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextStyleDisabled(tguiRenderer* thisRenderer, tguiUint32 value);
CTGUI_API tguiUint32 tguiButtonRenderer_getTextStyleDisabled(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextStyleDown(tguiRenderer* thisRenderer, tguiUint32 value);
CTGUI_API tguiUint32 tguiButtonRenderer_getTextStyleDown(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextStyleDownHover(tguiRenderer* thisRenderer, tguiUint32 value);
CTGUI_API tguiUint32 tguiButtonRenderer_getTextStyleDownHover(const tguiRenderer* thisRenderer);

CTGUI_API void tguiButtonRenderer_setTextStyleDownFocused(tguiRenderer* thisRenderer, tguiUint32 value);
CTGUI_API tguiUint32 tguiButtonRenderer_getTextStyleDownFocused(const tguiRenderer* thisRenderer);
...
CTGUI_API void tguiButtonRenderer_setRoundedBorderRadius(tguiRenderer* thisRenderer, float value);
CTGUI_API float tguiButtonRenderer_getRoundedBorderRadius(const tguiRenderer* thisRenderer);

#endif // CTGUI_BUTTONRENDERER_H
