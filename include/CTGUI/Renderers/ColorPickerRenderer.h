...
#ifndef CTGUI_COLOR_PICKER_RENDERER_H
#define CTGUI_COLOR_PICKER_RENDERER_H

#include <CTGUI/Global.h>

CTGUI_API tguiRenderer* tguiColorPickerRenderer_create(void);
CTGUI_API tguiRenderer* tguiColorPickerRenderer_copy(const tguiRenderer* renderer);
...
#endif // CTGUI_COLOR_PICKER_RENDERER_H
