...
CTGUI_API void tguiLabelRenderer_setTextColor(tguiRenderer* thisRenderer, const tguiColor* value);
CTGUI_API const tguiColor* tguiLabelRenderer_getTextColor(const tguiRenderer* thisRenderer);

CTGUI_API void tguiLabelRenderer_setTextOutlineColor(tguiRenderer* thisRenderer, const tguiColor* value);
CTGUI_API const tguiColor* tguiLabelRenderer_getTextOutlineColor(const tguiRenderer* thisRenderer);
...
CTGUI_API void tguiLabelRenderer_setBackgroundColor(tguiRenderer* thisRenderer, const tguiColor* value);
CTGUI_API const tguiColor* tguiLabelRenderer_getBackgroundColor(const tguiRenderer* thisRenderer);

CTGUI_API void tguiLabelRenderer_setBorderColor(tguiRenderer* thisRenderer, const tguiColor* value);
CTGUI_API const tguiColor* tguiLabelRenderer_getBorderColor(const tguiRenderer* thisRenderer);
