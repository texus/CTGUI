...
CTGUI_API void tguiPanelRenderer_setBackgroundColor(tguiRenderer* thisRenderer, tguiColor value);
CTGUI_API tguiColor tguiPanelRenderer_getBackgroundColor(const tguiRenderer* thisRenderer);

CTGUI_API void tguiPanelRenderer_setBorderColor(tguiRenderer* thisRenderer, tguiColor value);
CTGUI_API tguiColor tguiPanelRenderer_getBorderColor(const tguiRenderer* thisRenderer);
