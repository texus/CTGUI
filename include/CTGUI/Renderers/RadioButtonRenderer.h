...
CTGUI_API void tguiRadioButtonRenderer_setTextDistanceRatio(tguiRenderer* renderer, float value);
CTGUI_API float tguiRadioButtonRenderer_getTextDistanceRatio(const tguiRenderer* renderer);

CTGUI_API void tguiRadioButtonRenderer_setBorders(tguiRenderer* renderer, tguiOutline* outline);
...
CTGUI_API tguiUint32 tguiRadioButtonRenderer_getTextStyle(const tguiRenderer* renderer);

CTGUI_API void tguiRadioButtonRenderer_setTextStyleChecked(tguiRenderer* renderer, tguiUint32 style);
CTGUI_API tguiUint32 tguiRadioButtonRenderer_getTextStyleChecked(const tguiRenderer* renderer);
